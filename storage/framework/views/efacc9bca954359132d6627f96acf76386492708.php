                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <span id="goBack" title="Click here to go back to Sub Category List">
                            <a href="<?php echo e(route('subcategory')); ?>">Back to list</a>
                        </span>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <?php echo $__env->make('errors.error', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <form method="post" action="<?php echo e(route('subcategory.edit.post')); ?>" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="chosen-select form-control" id="ddlCategory" name="category">
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category->id); ?>" <?php echo e($subcategory->category->id == $category->id ? "selected" : ""); ?>><?php echo e($category->name); ?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" id="txtName" name="name" value="<?php echo e($subcategory->name); ?>"
                                                   placeholder="Name"
                                                   class="form-control">
                                        </div>
                                    </div>
